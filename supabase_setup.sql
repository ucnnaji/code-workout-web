...
insert into public.modalities (id, label, description, sort_order, active) values
  ...
  ('code-explanation','Code Explanation','Predict and explain program behavior.',3,true),
  ('code-completion','Code Completion','Complete missing parts of starter code.',4,true)
...
-- Questions are seeded below. There are 20 per modality per language (160 total).
...
-- Helpful integrity check. Expected: 8 rows, each with question_count = 20.
